...
export function OfficialForm({ apiKey, authToken }: OfficialFormProps) {
    ...
    const filteredOfficials = filterRole === 'all'
        ? officials
        : officials.filter(o => o.roles.includes(filterRole));
        ...
        <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div className="pt-2">
                        <button
                            type="submit"
                            className={`w-full py-3 rounded-xl font-bold text-white shadow-lg shadow-blue-500/20 transition-all active:scale-[0.98] ${isEditing ? 'bg-amber-500 hover:bg-amber-600' : 'bg-blue-600 hover:bg-blue-700'
                                }`}
                        >
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div className="p-5 border-b border-slate-100 bg-slate-50/50 flex flex-wrap gap-4 justify-between items-center">
                    <h3 className="font-bold text-slate-800">Kayıtlı Yetkililer ({officials.length})</h3>
