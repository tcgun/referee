...
import { cleanSponsorsInText } from '@/lib/teams';
    ...
    return (
        <main className="min-h-screen bg-[#0d1117] text-white pb-20">
            ...
            <div className="max-w-7xl mx-auto px-4 -mt-8">
                {/* Sezon Seçici */}
                <div className="flex items-center justify-between gap-4 bg-[#161b22] p-3 rounded-2xl border border-white/10 shadow-2xl flex-wrap mb-8">
                ...
                {data.teams.length === 0 ? (
                    <div className="text-center py-20 bg-[#161b22] border-2 border-white/20 rounded-2xl text-muted-foreground text-xs font-bold uppercase tracking-[0.2em] shadow-xl mt-8">
                                ...
                                <div className="bg-[#161b22] border-2 border-white/20 rounded-2xl p-6 shadow-neo-sm">
                                    ...
                                    <div className="h-40 flex items-end gap-1.5 pt-4">
                                        {data.weeklyTrend.map((w, i) => {
                                            const max = Math.max(...data.weeklyTrend.map(t => t.total), 1);
